...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.mode_select_frame = QtWidgets.QFrame(self.horizontalFrame)
        self.mode_select_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.mode_select_frame.setObjectName("mode_select_frame")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.mode_select_frame)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.label_4 = QtWidgets.QLabel(self.mode_select_frame)
        self.label_4.setObjectName("label_4")
        self.verticalLayout_5.addWidget(self.label_4)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.radioButton_norm = QtWidgets.QRadioButton(self.mode_select_frame)
        ...
        self.radioButton_graph = QtWidgets.QRadioButton(self.mode_select_frame)
        ...
        self.gridLayout.addWidget(self.mode_select_frame, 0, 0, 1, 1)
        ...
        self.key_select_frame = QtWidgets.QFrame(self.verticalFrame_3)
        self.key_select_frame.setFrameShape(QtWidgets.QFrame.Box)
        self.key_select_frame.setObjectName("key_select_frame")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.key_select_frame)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.label_3 = QtWidgets.QLabel(self.key_select_frame)
        self.label_3.setWordWrap(True)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_2.addWidget(self.label_3)
        self.dropdown_key = QtWidgets.QComboBox(self.key_select_frame)
        self.dropdown_key.setObjectName("dropdown_key")
        self.verticalLayout_2.addWidget(self.dropdown_key)
        self.verticalLayout_3.addWidget(self.key_select_frame)
        ...
        self.button_csv_export = QtWidgets.QPushButton(self.graph_zoom_frame)
        self.button_csv_export.setObjectName("button_csv_export")
        self.verticalLayout_6.addWidget(self.button_csv_export)
...
""))
        ...
        self.button_csv_export.setText(_translate("MainWindow", "CSV"))
